...
log.info('🚀 JAEGER AI ULTIMATE v3.0.1 - Starting...');
...
const securityTools = {
    ...
    gobuster: {
        ...
        commands: {
            basic: 'gobuster dir -u https://{target} -w /usr/share/wfuzz/wordlist/general/common.txt -t 20 -q -x php,html,txt --no-error',
            dir: 'gobuster dir -u https://{target} -w /usr/share/wfuzz/wordlist/general/common.txt -t 20 -q -x php,html,txt --no-error',
    ...
    httpx: {
        ...
        commands: {
            basic: 'echo {target} | httpx',
            probe: 'echo {target} | httpx -probe'
        }
    },
    wafw00f: {
...
3. TOOLS: Jika traditional, rekomendasikan 3-5 tools terbaik
...
Respon dalam format JSON:
{
  ...
  "explanation": "Penjelasan singkat mengapa memilih approach ini"
}`;
...
• Smart tool selection and recommendations
...
bot.launch()
    .then(() => {
        log.success('🚀 JAEGER AI ULTIMATE v3.0.1 is ONLINE!');
